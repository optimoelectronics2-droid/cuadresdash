...
echo [1/2] Servidor iniciado en http://localhost:3456
echo.
...
start /B "" cmd /c "C:\Users\Brailin\Documents\Dashboard\cloudflared.exe tunnel --url http://localhost:3456 > tunnel-log.txt 2>&1"
